...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="tag-1">
            ...
            <!-- Tab panes -->
            <form class="tag-3" action="index.php?menu=tag&submenu=action" method="POST" id="tag_form">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <?php if (!empty($edit_id)) { ?>
                                        <div class="edit_slug" data-action="edit_slug_container"
                                             data-url="index.php?menu=tag&submenu=action" data-id="<?= $edit_id ?>"
                                             data-lang="<?= $lang['key'] ?>">
                                            <span class="edit_slug_label"><?= CUrlManager::GetStaticURL('post_category', null, $lang['key']) ?></span>
